This is a synthesizable face detector in SystemC using Viola-Jones algorithm, tested with commercial high-level synthesis tools. It takes in 360 x 240 8-bit grayscale images, and outputs the coordinates of the faces detected. You can complie the code and run pure software simulation using the cammands (check and configure the SystemC path in the Makefile before make):
	$make
	$./facedetect.exe
